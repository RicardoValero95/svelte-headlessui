        ...
        <span class="inline-block w-full rounded-md shadow-sm">
          ...
          >
            {#if active && Array.isArray(active)}
              {#each active as active}
                <div
                  class=" text-xs inline-flex items-center  leading-sm  px-3 py-1 bg-orange-200 text-orange-700 rounded-full"
                >
                  {active}
                </div>
              {/each}
