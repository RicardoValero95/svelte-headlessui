...
describe("Rendering", () => {
  ...
  it("should be possible to render a RadioGroup with an active value", async () => {
    render(TestRenderer, {
      allProps: [
        [
          RadioGroup,
          { value: "home-delivery", onChange: console.log },
          [
            [RadioGroupLabel, {}, "Pizza Delivery"],
            [RadioGroupOption, { value: "pickup" }, "Pickup"],
            [RadioGroupOption, { value: "home-delivery" }, "Home delivery"],
  ...
  it("should be possible to disable a RadioGroup", async () => {
    ...
    expect(
      document.querySelector('[data-value="slot-prop"]')
    ).toHaveTextContent(
      JSON.stringify({
        checked: false,
        disabled: true,
    ...
    it("should not change the selected element on focus", async () => {
      ...
      render(TestRenderer, {
        allProps: [
          [
            RadioGroup,
            { value: undefined, onChange: changeFn },
            [
              [RadioGroupLabel, {}, "Pizza Delivery"],
              [RadioGroupOption, { value: "pickup" }, "Pickup"],
              [RadioGroupOption, { value: "home-delivery" }, "Home delivery"],
    ...
    it("should not change the selected element on focus (when selecting the active item)", async () => {
      ...
      render(TestRenderer, {
        allProps: [
          [
            RadioGroup,
            { value: "home-delivery", onChange: changeFn },
            [
              [RadioGroupLabel, {}, "Pizza Delivery"],
              [RadioGroupOption, { value: "pickup" }, "Pickup"],
              [RadioGroupOption, { value: "home-delivery" }, "Home delivery"],
      ...
      render(TestRenderer, {
        allProps: [
          ...
          [
            ...
            {
              value: undefined,
              onChange: (e: CustomEvent) => changeFn(e.detail),
            },
            [
              [RadioGroupLabel, {}, "Pizza Delivery"],
              [RadioGroupOption, { value: "pickup" }, "Pickup"],
