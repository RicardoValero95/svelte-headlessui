  ...
  describe("PopoverButton", () => {
    ...
    describe("`type` attribute", () => {
      ...
      it('should not set the `type` to "button" if it already contains a `type`', async () => {
        render(TestRenderer, {
          allProps: [
            [Popover, {}, [[PopoverButton, { type: "submit" }, "Trigger"]]],
          ],
        });
                    ...
                    [
                      [
                        ...
                        [
                          [
                            TransitionDebug,
                            { name: "TransitionChild", fn: orderFn },
                          ],
                        ],
                      ],
                    ],
    ...
    suppressConsoleLogs(async () => {
      ...
      render(TestRenderer, {
        allProps: [
          ...
          [Button, { id: "btn" }, [[Span, {}, "Different button"]]],
        ],
      });
      ...
      render(TestRenderer, {
        allProps: [
          [
            ...
            [
              [PopoverButton, {}, "Open"],
              [PopoverPanel, { static: true }, [[Span, {}, "element"]]],
            ],
          ],
        ],
      });
