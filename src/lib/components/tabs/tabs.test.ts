  ...
  describe(`'Tab'`, () => {
    describe("`type` attribute", () => {
      it('should set the `type` to "button" by default', async () => {
        render(TestRenderer, {
          allProps: [[TabGroup, {}, [[TabList, {}, [[Tab, {}, "Trigger"]]]]]],
        });
        ...
        render(TestRenderer, {
          allProps: [
            [
              TabGroup,
              {},
              [[TabList, {}, [[Tab, { type: "submit" }, "Trigger"]]]],
            ],
          ],
        });
      ...
      it('should not set the type if the "as" prop is not a "button"', async () => {
        render(TestRenderer, {
          allProps: [
            [TabGroup, {}, [[TabList, {}, [[Tab, { as: "div" }, "Trigger"]]]]],
          ],
        });
    ...
    it("should be possible to go to the previous item (activation = `manual`)", async () => {
      render(TestRenderer, {
        allProps: [
          [
            TabGroup,
            { defaultIndex: 2, vertical: true, manual: true },
            [
              [
                TabList,
                {},
...
it("should trigger the `on:change` when the tab changes", async () => {
  ...
  render(TestRenderer, {
    allProps: [
      [
        TabGroup,
        { onChange: (e: CustomEvent) => changes(e.detail) },
        [
          [
            TabList,
            {},
