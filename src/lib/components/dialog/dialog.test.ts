    ...
    it("should be possible to always render the Dialog if we provide it a `static` prop (and enable focus trapping based on `open`)", async () => {
      ...
      render(TestRenderer, {
        allProps: [
          ...
          [
            Dialog,
            { open: true, onClose: console.log, static: true },
            [
              [P, {}, "Contents"],
    ...
    it("should be possible to always render the Dialog if we provide it a `static` prop (and disable focus trapping based on `open`)", () => {
      ...
      render(TestRenderer, {
        allProps: [
          ...
          [
            Dialog,
            { open: false, onClose: console.log, static: true },
            [
              [P, {}, "Contents"],
              [TestTabSentinel, { onFocus: focusCounter }],
            ],
      ...
      suppressConsoleLogs(async () => {
        render(TestRenderer, {
          allProps: [
            [
              ManagedDialog,
              { buttonText: "Trigger", buttonProps: { id: "trigger" } },
              [
      ...
      render(TestRenderer, {
        allProps: [
          ...
          [
            Dialog,
            { onClose: console.log },
            [[DialogDescription, {}, "Description"], [TestTabSentinel]],
          ],
        ],
      });
        ...
        render(TestRenderer, {
          allProps: [
            [
              ManagedDialog,
              { buttonText: "Trigger", buttonProps: { id: "trigger" } },
              ["Contents", [Input, { id: "name" }], [TestTabSentinel]],
            ],
          ],
        });
      ...
      render(TestRenderer, {
        allProps: [
          [
            ManagedDialog,
            { buttonText: "Trigger", buttonProps: { id: "trigger" } },
            [[DialogOverlay], "Contents", [TestTabSentinel]],
          ],
        ],
      });
          ...
          [
            ...
            [
              [
                ManagedDialog,
                { initialOpen: true },
                ["Contents", [DialogOverlay], [TestTabSentinel]],
              ],
            ],
          ],
        ],
        ...
        allProps: [
          [
            ...
            [
              [
                ManagedDialog,
                { initialOpen: true, buttonInside: true, buttonText: "Inside" },
                ["Contents", [TestTabSentinel]],
              ],
            ],
          ],
